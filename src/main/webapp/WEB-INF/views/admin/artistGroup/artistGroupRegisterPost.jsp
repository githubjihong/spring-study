...
// 			expln += '무한루프를 보고 우리의 마음에 행복이 끊임없이 점유한다면 얼마나 좋을까? 라는 의미로 지었다고 한다.';
			artGroupDebutYmd.value="20130826";
			artGroupNm.value="SUNMI"
			artGroupNmKo.value="선미"
			let expln = '';
			expln += '선미는 공개 오디션을 통해 JYP 엔터테인먼트 연습생으로 들어가게 되었는데, 2년 동안 연습생 생활을 한 뒤 원더걸스 멤버로 합류하였다. ';
			expln += '프로듀서 박진영은 선미의 장점으로 "안정된 보컬 능력"을 꼽았으며 원더걸스 멤버로 선발한 이유를 "귀여운 외모에 비해 성숙한 목소리"로 꼽았다.';
