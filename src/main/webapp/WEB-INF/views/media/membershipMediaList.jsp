...
<ul class="nav nav-pills justify-content-center gap-5 medi-subnav">
  ...
  <li class="nav-item">
    <a class="nav-link active" style="background-color: #ff69b4 !important" aria-current="page" href="${pageContext.request.contextPath}/oho/community/media/mebership?artGroupNo=${param.artGroupNo}">멤버쉽 미디어</a>
  </li>
  <li class="nav-item">
      ...
      <div class="media-thumb-wrapper" style="height: 180px; overflow: hidden;">
        <c:choose>
          <c:when test="${mediaPostVO.mediaMebershipYn eq 'Y'}">
            <c:choose>
              <c:when test="${not empty usersVO.memberVO.memberShipList}">
                <!-- 멤버십 사용자 -->
