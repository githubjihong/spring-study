                ...
                <div class="col">
                    <div class="card h-100 rounded-3">
                        <div style="height: 180px; overflow: hidden;">
                        	...
                        	<a class="btn px-1 py-1" style="height: 100%" href="${pageContext.request.contextPath}/oho/community/media/post?postNo=${mediaPostVO.mediaPostNo}&artGroupNo=${param.artGroupNo}">
	                            <img src="https://img.youtube.com/vi/${mediaPostVO.mediaVideoUrl}/maxresdefault.jpg" 
