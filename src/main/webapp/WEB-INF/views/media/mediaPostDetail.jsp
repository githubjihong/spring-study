 ...
 <div class="row py-4" style="height:100%;">
	<div class="col col-md-9">
		...
		<div style="height: 15%; padding-top: 20px">
			<pre class="text-wrap" style="color:white; white-space: pre-wrap;">${mediaPostVO.mediaPostCn}
				 ${communityProfileVO}
			</pre>
		</div>
	</div>
    ...
    replyList.forEach(reply => { // reply는 객체임, key:value
        ...
        commentHtml += `</ul>
                ...
                <div class="col comment-content">
                  <div class="multiline-truncate card-reply" style="color:white; max-width: 100%;" data-original="\${reply.replyContent}">\${reply.replyContent}</div>
