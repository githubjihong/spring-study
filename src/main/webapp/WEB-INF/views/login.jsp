...
<div class="limiter">
			...
			<div class="wrap-login100">
				<div class="login100-pic js-tilt" data-tilt="" style="will-change: transform; transform: perspective(300px) rotateX(0deg) rotateY(0deg);">
					...
					<form class="login100-form validate-form" action="/login" method="post">
						...
						<div class="d-flex">
							<button class="btn btn-sm btn-secondary" style="width: 40%;" id="fanLogin">
								팬
							</button>
	...
	document.getElementById("fanLogin").addEventListener("click", ()=>{
		document.querySelector("input[name=username]").value="2@naver.com";
		document.querySelector("input[name=password]").value="java";
	});
	document.getElementById("artLogin").addEventListener("click", ()=>{
		document.querySelector("input[name=username]").value="tjsal@gmail.com";
		document.querySelector("input[name=password]").value="java";
	});
