			...
			<div id="voteArtist" style="background-color: #D0F5F2; width: 80%; height: 120px; margin-left: 110px; border-radius: 10px;">
				<div class="row">
					...
					<div class="col-5 mt-3" style="padding:0">
						<h4 style="font-weight: 600; margin-bottom: 5px;">띵동! oHoT 인기투표가 시작되었어요.</h4>
						<h6 style="color: #666; margin-top: 10px;">당신의 아티스트를 투표해 보세요!</h6>
						<a href="/oho/game/play" style="text-decoration: none; color: #F86D72; !important; font-weight: 500;"> 투표하러 가기 ▶ </a>
					</div>
