    ...
    <div class="row justify-content-center align-items-center">
      <div class="col-md-10 d-flex rounded overflow-hidden" style="background-color: white; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
        ...
        <div class="col-md-6 p-3" style="background: #fafafa;">
          <img src="/images/noImage.png" class="img-fluid rounded w-100" alt="방송 썸네일" style="max-height: 250px; object-fit: cover;">
        </div>
...
<div class="container-fluid px-6 py-3" id="custom-cards">
    <div class="d-flex justify-content-between align-items-center ps-5 pb-2 border-bottom">
        ...
        <c:forEach var="mediaPostVO" items="${mediaPostVOList}">
          <c:if test="${mediaPostVO.mediaMebershipYn eq 'L'}">
        ...
        <c:forEach var="mediaPostVO" items="${mediaPostVOList}" varStatus="stat">
            <c:if test="${mediaPostVO.mediaMebershipYn eq 'L' && count}">
                <div class="col">
