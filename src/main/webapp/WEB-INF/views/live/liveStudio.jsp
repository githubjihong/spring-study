...
<div class="media-container container-fluid px-6 py-4" style="min-height: 1000px;">
    ...
    <div class="comment-container col-3 flex">
      ...
      <div class="comment-header row row-1 fw-bold" style="padding-left: 10px;">
        ...
        <div class="col-8 fs-6">
          <span>시청자 <span id="currentViewers">0</span>명 | 누적 <span id="totalViewers">0</span>명</span>
        </div>
      </div>
      
      <!-- 채팅 본문 영역 -->
      <div id="comment-body" class="comment-body row row-md-10" style="height: 600px;">
